...
from chalengeSolver.cache_handler import fetch_pokemon_names, fetch_sw_characters, fetch_sw_planets, load_cache, save_cache
...
class ChallengeSolver:
    def __init__(self, token):
        ...
        self.cache_file = "./cache/api_cache.json"
